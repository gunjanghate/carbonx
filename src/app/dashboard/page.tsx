...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 p-8 flex flex-col items-center">
      <h1 className="text-3xl font-bold text-zinc-100 mb-6">Carbon Ledger Dashboard</h1>
      ...
      <div className="w-full max-w-7xl">
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-zinc-100 mb-4">Welcome to Carbon Ledger</h2>
