...
Click the **Fork** button at the top-right corner of the [Carbon Ledger repository](https://github.com/AkshitTiwarii/Carbon Ledger).  
...
```bash
git remote add upstream https://github.com/AkshitTiwarii/Carbon Ledger.git
```
...
- Open a [discussion](https://github.com/AkshitTiwarii/Carbon Ledger/discussions)
- Or reach out via [issues](https://github.com/AkshitTiwarii/Carbon Ledger/issues)
...
Thank you for helping improve **Carbon Ledger**! 🌟
